<a name="readme-top">EXPENSE TRACKER</a>
...
- [Live Demo Link](https://expense-tracker-ochre-ten.vercel.app/)
...
```sh
  cd my-folder
  git clone https://github.com/Irirwanirira/expense-tracker.git
```
-
...
## 👥 Author <a name="authors">Joseph Irirwanirira</a>
...
- [ ] **[Add sub categories for transactions]**
- [ ] **[Add momo account and track on it]**
- [ ] **[Allow multiple users of the app]**
...
Feel free to check the [issues page](https://github.com/Irirwanirira/expense-tracker/issues).
...
Join us in our mission for innovation, sustainability, and social good. Your contribution can make a significant difference and help us create a better world.

Be a catalyst for change and support our project today!
...
I would like to thank code of AFRICA for the project Idea
